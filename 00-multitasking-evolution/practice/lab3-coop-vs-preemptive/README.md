...
__ตอบ__ Preemptive ดีกว่า เพราะระบบสามารถแทรกงานสำคัญได้ทันทีไม่ต้องรอ task อื่นยอมสละ CPU

2. ข้อดีของ Cooperative Multitasking คืออะไร?
__ตอบ__ โครงสร้างง่าย ควบคุมลำดับการทำงานได้ ใช้ทรัพยากรน้อย

3. ข้อเสียของ Cooperative Multitasking คืออะไร?
__ตอบ__ ถ้า task หนึ่งไม่ยอม yield ระบบทั้งหมดยังทำงานต่อไม่ได้

4. ในสถานการณ์ใดที่ Cooperative จะดีกว่า Preemptive?
__ตอบ__ เหมาะกับงานง่าย ๆ ที่ไม่ต้องการตอบสนองแบบ real-time

5. เหตุใด Preemptive จึงเหมาะสำหรับ Real-time systems?
__ตอบ__ เพราะ RTOS สามารถจัดลำดับความสำคัญและสลับ task ได้ทันที
