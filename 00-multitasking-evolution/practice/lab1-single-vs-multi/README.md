...
__ตอบ__ Single Task ตอบสนองช้า เพราะทำทีละงาน ต้องรอให้ทุกงานจบก่อนถึงจะเช็กปุ่มได้

2. ใน Single Task System งานไหนที่ทำให้การตอบสนองล่าช้า?
__ตอบ__ งานที่ทำให้ช้าคือ การประมวลผลข้อมูล

3. ข้อดีของ Multitasking System ที่สังเกตได้คืออะไร?
__ตอบ__ ตอบสนองเร็ว ทำหลายงานพร้อมกันได้ เช่น LED กระพริบกับปุ่มทำงานพร้อมกัน
4. มีข้อเสียของ Multitasking System ที่สังเกตได้หรือไม่?
__ตอบ__ โค้ดซับซ้อนขึ้น ต้องจัดลำดับความสำคัญดี ๆ ไม่งั้นงานอาจแย่งกันทำงาน
...
| Multitasking | < 100ms | ทำงานพร้อมกัน | แกันใช้ |
